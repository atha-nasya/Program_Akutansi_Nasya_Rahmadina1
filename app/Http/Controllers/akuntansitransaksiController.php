...
class akuntansitransaksiController extends Controller
{
    ...
    public function tambah(){
     ...
     public function tambah_proses(Request $request){
         ...
         $query = \DB::table('nasyatbl_akuntansi_transaksi')
         ->insert([
     ...
     public function edit($id){
         // return ('Testing');
         $akuntansitransaksi = \DB::table('nasyatbl_akuntansi_transaksi')->where('id', $id)->first();
         //dd($akun);
         $data = array('akuntansitransaksi' => $akuntansitransaksi);
     ...
     public function edit_proses(Request $request){
         // return ('Testing Proses');
         $query = \DB::table('nasyatbl_akuntansi_transaksi')->where('id',$request->id)
         ->update([
            'kode_jurnal'  =>  $request->kode_jurnal,
            'nomor_perkiraan'  =>  $request->nomor_perkiraan,
            'tanggal_transaksi'  =>  $request->tanggal_transaksi,
     ...
     public function delete ($id){
         $query = \DB::table('nasyatbl_akuntansi_transaksi')->where('id',$id)->delete();
         return redirect('akuntansitransaksi');
     }
 }
